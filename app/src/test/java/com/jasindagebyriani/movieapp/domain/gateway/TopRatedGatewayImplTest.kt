...
class TopRatedGatewayImplTest {
    ...
    @Before
    fun setup() {
        topRatedGateway = TopRatedGatewayImpl(createApi())
    }

    @Test
    fun `given response success when getMovie should return TopRated entity`() {
        server.enqueue(MockResponse().setResponseCode(200).setBody(topRatedResponses))
    ...
    @Test
    fun `given response success with null path when getMovie should return TopRated entity with empty path`() {
        server.enqueue(MockResponse().setResponseCode(200).setBody(topRatedResponseWithNullPath))
    ...
    companion object {
        ...
        private val topRatedResponseWithNullPath = """
            {
            "page": 1,
            "results": [
            {
